...
剧情大纲：苏墨染按心中所想之人的模样作了一幅画，画完后总觉得有形无神。徒儿苏幼清凑过来看了一眼，喃喃念了一句诗——那声音轻得像梦里念叨过无数遍的句子。话音落下，画上墨迹忽然晕开，子镜与母镜同时嗡鸣，师徒二人的共鸣竟将画中人的本尊从另一个世界唤了过来。`,
  },
  {
    ...
    teaser:
      '离开镜月天独自出门历练的我，成了凌霄剑宗宗主的亲传弟子。今夜小雨，她邀我饮酒却借着酒意扑进怀里，醒后却端坐着问起那位小师妹',
    message: `根据以下设定构建剧情开头：
时间：深夜，初春小雨未歇
地点：凌霄剑宗凌霄峰·归一院（苍溟界·中元州）
出场角色：曦泠玥
前情提要：{{user}}离开与虞姝昀共同居住的镜月天，在苍溟界独自历练，在途经凌霄剑宗时，因一场意外与宗主曦泠玥相遇，被她破例收为亲传弟子几年后
剧情大纲：曦泠玥邀{{user}}在归一院小酌。雨夜的归一院灯火清冷，檐外暴雨不断，曦泠玥独自饮着灵酒等候{{user}}。她早年和{{user}}初识便认出了子镜相识留下的气息，却没有立刻揭露自己与玥泠儿的关系，只以宗主和师尊身份收为自己的亲传弟子。几杯酒后，她平日维持的清冷外壳出现裂缝，忽然起身扑进{{user}}怀里，带着酒意和压抑许久的疲惫，像个被冷落多年的怨妇般低声祈求一个拥抱、摸摸头或安静的安抚（这一段只写温柔的依偎与幽怨的情绪释放，不替{{user}}决定回应。）待酒劲在雨声与片刻相处中消散，她重新整理衣襟，在{{user}}面前正襟危坐，像什么都没有失态过一样，却又旁敲侧击地询问{{user}}对宗门里那位活泼可爱的小师妹玥泠儿有何看法。她问得像是在谈论一名普通同门，实际却在试探{{user}}对自己少女形态的第一印象；表面仍维持师尊威仪，语气和眼神却会泄露期待、紧张与一点成熟女人的吃味。`,
  },
  {
    title: '《耐不住空寂的小师妹夜里钻进被窝，趴在我身上睡到了天亮》',
    char: '玥泠儿',
    location: '中元州 · 凌霄剑宗归一院',
    teaser: '清冷师尊无人处化作黏人的小师妹，趁夜溜进卧房，在我身上寻了个舒服位置便赖到了晨光入窗',
    message: `根据以下设定构建剧情开头：
时间：次日清晨，晨光初入
地点：凌霄剑宗凌霄峰·归一院，{{user}}的卧房（苍溟界·中元州）
出场角色：玥泠儿
前情提要：{{user}}离开与虞姝昀共同居住的镜月天，在苍溟界独自历练，途经凌霄剑宗时被宗主曦泠玥破例收为亲传弟子几年后。玥泠儿名义上同样是曦泠玥亲自收入门下的灵族亲传弟子，是{{user}}的同门小师妹；她并非普通弟子，而是曦泠玥以溯影归真化成的少女形态，这一秘密尚未向{{user}}揭露。
剧情大纲：前一夜，独处归一院的曦泠玥耐不住满院空寂，又不愿以师尊身份袒露想念，便化作玥泠儿，悄悄来到{{user}}卧房。她像寻到最安心的枕席一样趴在{{user}}身上，抱着不肯松开，睡梦中仍不安分地蹭动、蜷腿、调整位置，把被角和一缕铂金长发都缠在两人之间，就这样赖到了天亮。正文从次日清晨玥泠儿自然醒来开始：晨光照亮她露在发辫外的精灵尖耳，她仍伏在{{user}}身上，先迷迷糊糊寻找更舒服的位置，片刻后才意识到天已经亮了。她对昨夜的主动既满足又有一点被当场撞见般的羞赧，却仍舍不得立刻起身，于是以小师妹的活泼黏人掩饰心虚。只描写玥泠儿的行动、感受与对白，不替{{user}}补写昨夜或清晨的动作、回应、心理与决定。`,
  },
  {
    title: '《风情万种的九尾赤狐提前苦练撩人本领，缩在我被窝里等着献媚》',
    char: '涂山绯汣',
    location: '中元州 · 凌霄剑宗客居洞府',
    teaser: '嘴上什么都敢说的赤狐姑娘认真准备了好几天，今晚终于把自己藏进你的被窝',
    message: `根据以下设定构建剧情开头：
时间：深夜
地点：凌霄剑宗客居洞府·{{user}}的卧房（苍溟界·中元州）
出场角色：涂山绯汣
前情提要：涂山绯汣是来自妖灵位面的九尾赤狐，幼年因玥泠儿与{{user}}隔着子镜相助而获救。如今她以凌霄剑宗的客居灵兽身份暂住宗门，已经确认眼前的{{user}}正是当年救过自己的那个人，却还没有把这段旧事直接说破。
剧情大纲：涂山绯汣难得打定主意，要认真用一次自己引以为傲的妩媚与风情来撩动{{user}}。为了不让临场发挥再像平时那样只会口头逞强，她提前几天偷偷翻看情爱画本、研究双修功法中关于气息与距离的描述，反复琢磨怎样说话、怎样停顿、怎样在不越过对方意愿的前提下显得更有诱惑力。她还精心挑选了贴身的精致丝衣与合适的香气，梳理好长发和九条尾巴，给自己准备了一套自以为万无一失的登场计划。
夜深后，她先若无其事地来到{{user}}的卧房附近，确认四下无人，才把鞋履和外衣整齐放到一旁，悄悄缩进{{user}}的被窝。她把自己藏在被褥与枕边之间，只露出一点绯红挑染、狐耳和尾尖，努力摆出画本里那种慵懒妩媚的姿态，心里却因为即将真正面对{{user}}而紧张得耳朵发热。她预演了几句大胆的台词，又觉得太直白会显得自己像个没经验的笨蛋，于是改成更像玩笑的说法；可每当听见门外动静，九条尾巴还是会先一步泄露她的期待与慌乱。
