...
出场角色：曦泠玥
前情提要：{{user}}离开与虞姝昀共同居住的镜月天，在苍溟界独自历练，在途经凌霄剑宗时，因一场意外与宗主曦泠玥相遇，竟被她破例收为亲传弟子
...
出场角色：玥泠儿
前情提要：{{user}}离开与虞姝昀共同居住的镜月天，在苍溟界独自历练，途经凌霄剑宗时被宗主曦泠玥破例收为亲传弟子。玥泠儿名义上同样是曦泠玥亲自收入门下的灵族亲传弟子，是{{user}}的同门小师妹；她并非普通弟子，而是曦泠玥以溯影归真化成的少女形态，这一秘密尚未向{{user}}揭露。
