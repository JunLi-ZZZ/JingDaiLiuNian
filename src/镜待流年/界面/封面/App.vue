...
剧情大纲：苏墨染按心中所想之人的模样作了一幅画，画完后总觉得有形无神。徒儿苏幼清凑过来看了一眼，喃喃念了一句诗——那声音轻得像梦里念叨过无数遍的句子。话音落下，画上墨迹忽然晕开，子镜与母镜同时嗡鸣，师徒二人的共鸣竟将画中人的本尊从另一个世界唤了过来。`,
  ...
  {
    title: '《昨夜与小师妹双修，今晨师尊却步履稍缓、气色正好》',
    char: '曦泠玥',
    location: '中元州 · 凌霄剑宗归一院',
    teaser:
      '昨夜与小师妹相伴双修，今日照常去归一院拜见师尊。她起身比往常慢了些，气色却格外红润，望来的目光也藏着一丝柔意',
    message: `根据以下设定构建剧情开头：
时间：翌日上午，初春
地点：凌霄剑宗凌霄峰·归一院（苍溟界·中元州）
出场角色：曦泠玥
前情提要：{{user}}离开与虞姝昀共同居住的镜月天，在苍溟界独自历练，后被曦泠玥破例收为亲传弟子，至今已有数年。昨夜，{{user}}与已成年的小师妹玥泠儿相伴双修；今日如常来到归一院拜见师尊。两种身份的秘密尚未揭露
剧情大纲：从今日拜见开始。归一院里茶已沏好，曦泠玥正坐在窗边翻阅剑谱。听见来人，她抬眼招呼，起身时比往常稍缓，走动间也有一点不易察觉的不便；她的气色却红润明净，眉目舒展，清冷的仪态里留着满足后的柔和。她自然地关心徒儿今日的安排，言语仍有师尊的沉稳，目光却比平时多停留片刻。昨夜的相伴作为既定前情，余韵通过她当下的神态与举止呈现；谈话停在可以由{{user}}回应、关心或追问的地方，让这些细节成为后续相处的线索。`,
  },
  {
