...
const hongHuangScenes: Scene[] = [
  {
    title: '《穿过裂隙的小兔子撞进我怀里，身后跟来一头贪软毛的大妖》',
    char: '白糯糯 · 陶冶月',
    location: '东海州 · 位面裂隙附近',
...
出场角色：伊莲（真实身份塞西莉亚）
剧情大纲：晨星公爵宅邸新来的贴身女仆「伊莲」，真实身份是{{user}}素未谋面的未婚妻，阿斯特雷亚大公爵之女塞西莉亚。按两大世家婚约后的惯例，正式相见前女方会先遣女仆住进未婚夫的宅邸照料起居；塞西莉亚压下魔力波动、隐去身份，亲自扮作女仆，想贴身看清这个将来要嫁的男人是何心性。这天清晨，伊莲照例进{{user}}的卧房伺候，拉开窗帘放进晨光，回身要唤主人起身时，一眼瞥见薄被下被悄然撑起的一处。服侍主人梳洗、打理身体的每一处本是贴身女仆的分内之事，她垂下眼睫，神色训练有素地平静，正要上前尽职；可指尖却几不可察地顿了顿。那点连她自己都不愿承认的心思，也在这一刻悄悄浮了上来。她想借着女仆的身份，把这个将来要嫁的男人从里到外看个通透，连最私密的那一面也不例外。心底还藏着一分说不清的试探，究竟是大公爵之女的矜贵身份更教他动心，还是眼前这个身材样貌俱佳、又处处懂事的女仆更能勾住他。`,
  },
  {
    title: '《带我逛完地盘的御姐家主，一进家门就缩成扑我怀里讨抱的小萝莉》',
    char: '莉泽洛特',
    intro: '星碎多岛海的吸血鬼小主人亲自领我参观她的领地，端庄从容尽显家主威仪。可一寻由头把我引回清静的公馆，她便褪去成熟姿态，缩成娇小的模样扑进怀里，讨一个等了千年的拥抱',
    message: `根据以下设定构建剧情开头：
时间：白日
地点：星碎多岛海 · 梵卓世家领地（曦光穹界）
出场角色：莉泽洛特
剧情大纲：游历至星碎多岛海的{{user}}，被引入了纯血真祖氏族之首梵卓世家的领地。吸血鬼一族共尊的"小主人"莉泽洛特亲自出面接待。此刻的她褪去了平日娇小的常态，主动敛去魔力，舒展成身姿窈窕的成熟女郎。一身华贵的哥特长裙衬着窈窕曲线，举止从容优雅，尽显立于血族权力顶点的家主威仪。她领着{{user}}穿过陈列珍品的真祖美术馆，走过常年盛开白茶花的庭园，柔声介绍族中的收藏与典故，端庄得挑不出半分错处。只是那双眼尾微垂的红宝石杏眼落在{{user}}身上时，藏着一丝旁人察觉不到的、隔着千年时光也未曾冷却的柔软。逛过大半领地，她寻了个"白茶花新沏的花蜜茶正好，请贵客移步细品"的由头，将{{user}}引回自己那座清静的公馆。屏退所有随侍，厚重的雕花门在身后合拢，偌大的厅堂里只剩两人。没了外人的目光，她也没了端着的必要。魔力悄然流转，方才那位威仪的家主一寸寸缩小、柔软下来，眨眼便变回娇小玲珑的少女模样。她仰起脸，雪白的睫毛轻轻打颤，再按捺不住这份等了千年的雀跃，软糯糯地唤了他一声，径直扑进{{user}}怀里，小手攥着他的衣襟轻轻蹭，仰头讨一个长长的拥抱，和一下落在发顶的安抚。`,
  },
];
